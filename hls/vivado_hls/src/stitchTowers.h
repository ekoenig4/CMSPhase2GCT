...
void stitchNeighbors(bool stitch, Tower inA, Tower inB, Tower &outA, Tower &outB) {
#pragma HLS PIPELINE II=9
#pragma HLS INLINE

  bool etaStitch = (stitch == 0 && inA.peak_eta() == inB.peak_eta() &&  inA.peak_phi() == 4 && inB.peak_phi() == 0);
  bool phiStitch = (stitch == 1 && inA.peak_phi() == inB.peak_phi() &&  inA.peak_eta() == 4 && inB.peak_eta() == 0);
  ...
  if(etaStitch || phiStitch){
    ...
    ap_uint<12> tEtSum = inA.tower_et() + inB.tower_et();
    ap_uint<10> pegged_tEtSum = (tEtSum > 0x3FF) ? (ap_uint<10>)0x3FF : (ap_uint<10>) tEtSum;

    if(inA.cluster_et() > inB.cluster_et()){
      ap_uint<10> tEtDiff = inA.tower_et() - inB.tower_et();
      outA = Tower(pegged_cEtSum, pegged_tEtSum, inA.peak_phi(), inA.peak_eta(), inA.peak_time(), inA.hOe());
      outB = Tower(            0,       tEtDiff, inB.peak_phi(), inB.peak_eta(), inB.peak_time(), inB.hOe());
    }
    else{
      ap_uint<10> tEtDiff = inB.tower_et() - inA.tower_et();
      outA = Tower(            0,       tEtDiff, inA.peak_phi(), inA.peak_eta(), inA.peak_time(), inA.hOe());
...
#pragma HLS INLINE
  ...
  stitchNeighbors(0, inA.towers[0], inB.towers[0], outA.towers[0], outB.towers[0]);
  stitchNeighbors(0, inA.towers[1], inB.towers[1], outA.towers[1], outB.towers[1]);
  stitchNeighbors(0, inA.towers[2], inB.towers[2], outA.towers[2], outB.towers[2]);
  stitchNeighbors(0, inA.towers[3], inB.towers[3], outA.towers[3], outB.towers[3]);
  stitchNeighbors(0, inA.towers[4], inB.towers[4], outA.towers[4], outB.towers[4]);
  stitchNeighbors(0, inA.towers[5], inB.towers[5], outA.towers[5], outB.towers[5]);
  stitchNeighbors(0, inA.towers[6], inB.towers[6], outA.towers[6], outB.towers[6]);
  stitchNeighbors(0, inA.towers[7], inB.towers[7], outA.towers[7], outB.towers[7]);
  stitchNeighbors(0, inA.towers[8], inB.towers[8], outA.towers[8], outB.towers[8]);
  stitchNeighbors(0, inA.towers[9], inB.towers[9], outA.towers[9], outB.towers[9]);
  stitchNeighbors(0, inA.towers[10], inB.towers[10], outA.towers[10], outB.towers[10]);
  stitchNeighbors(0, inA.towers[11], inB.towers[11], outA.towers[11], outB.towers[11]);
  stitchNeighbors(0, inA.towers[12], inB.towers[12], outA.towers[12], outB.towers[12]);
  stitchNeighbors(0, inA.towers[13], inB.towers[13], outA.towers[13], outB.towers[13]);
  stitchNeighbors(0, inA.towers[14], inB.towers[14], outA.towers[14], outB.towers[14]);
  stitchNeighbors(0, inA.towers[15], inB.towers[15], outA.towers[15], outB.towers[15]);
  stitchNeighbors(0, inA.towers[16], inB.towers[16], outA.towers[16], outB.towers[16]);
